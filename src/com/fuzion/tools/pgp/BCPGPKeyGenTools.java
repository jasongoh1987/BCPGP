 ...
 *
 */
public final class BCPGPKeyGenTools {
    ...
    public static final PGPKeyRingGenerator createPGPKeyRingGeneratorForDSAKeyPair(KeyPair dsaKeyPair, KeyPair elGamalKeyPair, String identity, char[] passphrase) throws Exception
    {
     ...
     */
    @SuppressWarnings("deprecation")
    public static final PGPKeyRingGenerator createPGPKeyRingGeneratorForRSAKeyPair(KeyPair signKeyPair, KeyPair encryptKeyPair, String identity, char[] passphrase) throws Exception
    {
        ...
        PGPKeyRingGenerator keyRingGen = new PGPKeyRingGenerator(
	        ...
	        null,
	        null,
	        new JcaPGPContentSignerBuilder(signPgpKeyPair.getPublicKey().getAlgorithm(),HashAlgorithmTags.SHA1),
	        new JcePBESecretKeyEncryptorBuilder(PGPEncryptedData.AES_256, sha1Calc).setProvider("BC").build(passphrase)
        );
     ...
     * 
     * @param keySize 512 - 1024 (multiple of 64)
     * @return the RSA generated key pair
     * @throws NoSuchProviderException 
     * @throws NoSuchAlgorithmException 
     */
    public static final KeyPair generateRsaKeyPair(int keySize) throws NoSuchAlgorithmException, NoSuchProviderException
    {
